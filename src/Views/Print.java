...
public class Print extends javax.swing.JFrame {
  ...
  public void listAllPurchasesDetails(int id){
        List<Purchases> list = purchaseDao.listPurchaseDetail(id);
  ...
  //--------------------Calcular el total-----------------
    ...
    private void initComponents() {
        ...
        form_print.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 620, 250));
        ...
        getContentPane().add(btn_print_purchase, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 540, 150, -1));
